    ...
    @if(isset($thisBrandArticle))
            ...
            <div id="item1">
                <div class="item1box">
                    <div class="item1boxleft fl">
                        <div class="title"><a href="/xm/{{$thisBrandArticle->id}}/">{{$thisBrandArticle->brandname}}</a></div>
                    ...
                    <div class="item1boxmiddle fl">
                        ...
                        <a href="/xm/{{$thisBrandArticle->id}}/#item5"><div class="bottom"></div></a>
                    </div>
        ...
        <div class="brandinfo">
            <div id="item1">
                <div class="item1box">
                    <div class="item1boxleft fl">
                        <div class="title"><a href="/news/{{$thisarticleinfos->id}}/">{{$thisarticleinfos->brandname}}</a></div>
                    ...
                    <div class="item1boxmiddle fl">
                        ...
                        <a href="/news/{{$thisarticleinfos->id}}/#item5"><div class="bottom"></div></a>
                    </div>
                    <div class="item1boxright fr clearfix">
                        <a href="#item5"><img class="js_popup" src="/mobile/images/liuyan.png" alt="在线留言"></a>
                        <div class="text">在线留言</div>
                ...
                <div class="item7list">
                    <a href="/news/{{$xg_article->id}}.shtml">
                        <div class="left fl">
                            ...
                            <div class="text">
                                <div class="message">来源：中国教育招商网</div>

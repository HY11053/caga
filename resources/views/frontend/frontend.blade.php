...
<div class="zong_topbar clear">
    <div class="wrap_mar f12 clear">
        <div id="testDiv">
            <ul class="fl topbar_left"> <li class="fl"><span class="webtitle">欢迎访问中国教育招商网 @if(Request::getrequesturi()=='/')  晋江教育局网址为：<a target="_blank" href="http://www.jinjiang.gov.cn/zt/zt7/index.aspx?pid=863563" rel="nofollow">http://www.jinjiang.gov.cn</a>@endif </span> </li></ul>
        </div>
        <div class="top_right">
...
<div class="zong_logo wrap_mar clear" style="margin-top:0">
    ...
    <h1 class="fl"><a href="{{config('app.url')}}" title="中国教育招商网" class="logo_left" target="_self">中国教育招商网</a></h1>
    @else
        <h2 class="fl"><a href="{{config('app.url')}}" title="中国教育招商网" class="logo_left" target="_self">中国教育招商网</a></h2>
    @endif
...
<div class="footer clear">
    ...
    <div class="copyright">
        <p>中国教育招商网友情提示：多打电话、多咨询、实地考察，可降低投资风险！</p>

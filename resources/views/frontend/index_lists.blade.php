...
@section('main_content')
    ...
    <div class="w1200">
        ...
        <div class="zs-tj-bar bg-ff box-shadow">
            @if(isset($hotnew))
            <a target="_blank" href="/news/{{$hotnew->id}}.shtml" class="img-block magnify magnify-txt w420 pr"><img src="{{$hotnew->litpic}}" alt="{{$hotnew->title}}">
            ...
            <div class="fr tj-wz">
                @if(isset($cnewtop))
                <dl>
                    <dt><a target="_blank" href="/news/{{$cnewtop->id}}.shtml" class="s-oe">{{$cnewtop->title}}</a></dt>
                    <dd>{{$cnewtop->description}}</dd>
                </dl>
                @endif
                <ul>
                    @foreach($cnewtops as $cnewtop)
                    <li><a target="_blank" href="/news/{{$cnewtop->id}}.shtml">{{$cnewtop->title}}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
            ...
            <div class="fl w870 bg-ff box-shadow tab-bar">
                <div class="clearfix">
                    <ul class="zs-tw-list tab-item ">
                        ...
                        <li><a target="_blank" href="/news/{{$pagelist->id}}.shtml" class="img-block magnify"><img src="{{$pagelist->litpic}}" alt="{{$pagelist->title}}"></a>
                            <div class="f20">
                                <a target="_blank" href="/news/{{$pagelist->id}}.shtml">{{$pagelist->title}}</a>
                            </div>
            ...
            <div class="fr w320">
                ...
                <div class="bg-ff p20">
                    ...
                    <ul class="join-project mt30">
                        @foreach($latestbrands as $latestbrand)
                            <li>
                                <a target="_blank" href="/xm/{{$latestbrand->id}}.shtml" class="img-block magnify"><img src="{{$latestbrand->litpic}}" alt="{{$latestbrand->brandname}}"></a>
                                <p class="f16"><a target="_blank" href="/xm/{{$latestbrand->id}}.shtml">{{$latestbrand->brandname}}</a></p>
                ...
                <div class="plr20-tb15 bg-ff box-shadow mt20" >
                    ...
                    <ul class="tw-list tw-list-h80 mt5">
                        ...
                        <li><a target="_blank" href="/news/{{$latesenew->id}}.shtml" class="img-block magnify"><img  @if($latesenew->litpic) src="{{$latesenew->litpic}}" alt="{{$latesenew->tite}}" @else src="/public/images/noimg.jpg" @endif /></a>
                            <p class="f16">
                                <a target="_blank" href="/news/{{$latesenew->id}}.shtml">{{$latesenew->title}}</a>
                            </p>

...
@section('main_content')
    ...
    <div class="conl1 center">
        ...
        <ul style="margin-left: 30px;">
            <li><a href="" style="margin-top: 0px;">携手零食店加盟轻松实现财富梦想零</a></li>
            <li><a href="">食店加盟店铺选址重要吗</a></li>
            <li><a href="">零食店加盟投资您放心的创业选择</a></li>
            <li><a href="">零食店加盟利润要远超想象创业者更加明</a></li>
        </ul>

        <ul>
            <li><a href="" style="margin-top: 0px;">智选择投资开零食店获利惊人</a></li>
            <li><a href="">投资创业什么项目好？零食店加盟快速赚</a></li>
            <li><a href="">钱项目投资创业开零食店好吗</a></li>
            <li><a href="">零食店加盟“保姆式”扶持创业更有保障</a></li>
        </ul>
    </div>

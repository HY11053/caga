           ...
           @include('frontend.brand_info')
                                ...
                                <ul class="clearfix">
                                    @if(isset($brandnews))
                                        @foreach($brandnews as $brandnew)
                                            <li><a href="/news/{{$brandnew->id}}.shtml" title="{{$brandnew->title}}">{{$brandnew->title}}</a></li>
                                        @endforeach
                                    @endif
                                </ul>
                            </div>
            ...
            <div class="fr w320">
                <div class="plr20-tb15 mb20 bg-ff box-shadow ">
                    <div class="lh24">
                        <a target="_blank" href="/jyproject" class="fr s-c999">更多</a>
               ...
               <div class="plr20-tb15 bg-ff box-shadow mt20">
                ...
                <div class="plr20-tb15 bg-ff box-shadow mt20" >
                    ...
                    @foreach($latesnews as $latesnew)
                        @if($loop->first)
                            <a target="_blank" href="/news/{{$latesnew->id}}.shtml" class="img-block magnify magnify-txt h213 mt15"><img src="{{$latesnew->litpic}}" alt="{{$latesnew->title}}">
                                <div class="img-bg">
                                </div>
                                <p> {{$latesnew->title}}</p>
                            </a>
                    ...
                    <ul class="tw-list tw-list-h80 mt5">
                        @foreach($latesnews as $latesnew)
                        <li><a target="_blank" href="/news/{{$latesnew->id}}.shtml" class="img-block magnify"><img src="{{$latesnew->litpic}}" alt="{{$latesnew->title}}"></a>
                            <p class="f16"><a target="_blank" href="/news/{{$latesnew->id}}.shtml">{{$latesnew->title}}</a></p>

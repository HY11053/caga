            ...
            <div class="fl w870">
                ...
                <div class="ar_infos">
                        ...
                        <div id="article_brandinfo">
                            <table cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td class="td_style first_line"><strong><a href="/xm/{{$thisBrandArticle->id}}.shtml">{{$thisBrandArticle->brandname}}加盟</a></strong></td>
                                ...
                                <tr>
                                    ...
                                    <td class="td_style"><button class="btn btn-success ">点击查看<a href="{{config('app.url')}}/xm/{{$thisBrandArticle->id}}.shtml">{{$thisBrandArticle->brandname}}</a>品牌加盟信息</button> </td>
                                    <td class="td_color button_line">项目咨询</td>
                                    <td class="td_style"> <a href="{{config('app.url')}}/xm/{{$thisBrandArticle->id}}.shtml#msg"><button class="btn btn-danger ">快速咨询</button></a></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    @elseif($thisarticleinfos->brandname)
                        <div class="xg_news">
                            <div class="title"><strong>{{$thisarticleinfos->brandname}}品牌信息</strong></div>
                            <div id="article_brandinfo">
                                <table cellspacing="0">
                                    <tbody>
                                    <tr>
                                        <td class="td_color logo_size"><img src="{{$thisarticleinfos->litpic}}"></td>
                                        <td class="td_style first_line"><strong><a href="/news/{{$thisarticleinfos->id}}.shtml">{{$thisarticleinfos->brandname}}加盟</a></strong></td>
                                        <td class="td_color first_line">投资金额</td>
                                        <td class="td_style first_line">{{$thisarticleinfos->brandpay}}</td>
                                    </tr>
                                    <tr>
                                        <td class="td_color">加盟人气</td>
                                        <td class="td_style">{{$thisarticleinfos->brandnum}}</td>
                                        <td class="td_color">成立时间</td>
                                        <td class="td_style">{{$thisarticleinfos->brandtime}}</td>
                                    </tr>
                                    <tr>
                                        <td class="td_color">加盟费用</td>
                                        <td class="td_style">{{$thisarticleinfos->brandpay}}</td>
                                        <td class="td_color">区域特许</td>
                                        <td class="td_style">{{$thisarticleinfos->brandarea}}</td>
                                    </tr>
                                    <tr>
                                        <td class="td_color">公司名称</td>
                                        <td class="td_style">{{$thisarticleinfos->brandgroup}}</td>
                                        <td class="td_color">总部地址</td>
                                        <td class="td_style">{{$thisarticleinfos->brandaddr}}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="shangxiapian">
                        <p>@if(isset($prev_article)) <span>上一篇：<a href="{{config('app.url')}}/news/{{$prev_article->id}}.shtml" title="{{$prev_article->title}}">{{str_limit($prev_article->title,40,'')}}</a></span> @else 没有了 @endif </p>
                        <p>@if(isset($next_article))  <span class="right">下一篇：<a href="{{config('app.url')}}/news/{{$next_article->id}}.shtml" title="{{$next_article->title}}">{{str_limit($next_article->title,40,'')}}</a></span> @else 没有了 @endif  </p>
                    </div>
                    @include('frontend.liuyan')
                    <div class="xg_news">
                        <div class="title"><strong>@if(isset($thisBrandArticle->brandname)) {{$thisBrandArticle->brandname}}加盟资讯@endif</strong></div>
                        <div class="xw">
                            <ul class="clearfix">
                                @if(isset($xg_search))
                                    @foreach($xg_search as $search)
                                        <li><a href="/news/{{$search->id}}.shtml" title="{{$search->title}}">{{$search->title}}</a></li>
                                    @endforeach
                                @endif
                            </ul>
                        </div>
            ...
            <div class="fr w320">
                <div class="plr20-tb15 bg-ff box-shadow mb20 ">
                    <div class="lh24">
                        ...
                        <h3 class="f22">@if(isset($thisBrandArticle->brandname)){{str_replace('加盟','',$thisBrandArticle->arctype->typename)}}@else 热门@endif加盟项目</h3>
                    </div>
                ...
                <div class="plr20-tb15 bg-ff box-shadow mt20">
                    ...
                    <ul class="jm-xm-list mt5 mb10" style="margin-top: 10px;">
                        ...
                        <li><a target="_blank" href="/xm/{{$flashlingshibrand->id}}.shtml" class="img-block magnify"><img src="{{$flashlingshibrand->litpic}}" alt=""></a>
                            <p class="f16">
                                <a target="_blank" href="/xm/{{$flashlingshibrand->id}}.shtml">{{$flashlingshibrand->brandname}}</a>
                            </p>
                            <p class="f14">
                ...
                <div class="plr20-tb15 bg-ff box-shadow mt20" >
                    ...
                    @if(isset($cnew))
                    <a target="_blank" href="/news/{{$cnew->id}}.shtml" class="img-block magnify magnify-txt h213 mt15"><img src="{{$cnew->litpic}}" alt="{{$cnew->title}}">
                        <div class="img-bg">
                        </div>
                        <p>{{$cnew->title}} </p>
                    </a>
                    ...
                    <ul class="tw-list tw-list-h80 mt5">
                        ...
                        <li><a target="_blank" href="/news/{{$latestnewslist->id}}.shtml" class="img-block magnify"><img @if($latestnewslist->litpic) src="{{$latestnewslist->litpic}}" alt="{{$latestnewslist->tite}}" @else src="/public/images/noimg.jpg" @endif /></a>
                            <p class="f16"><a target="_blank" href="/news/{{$latestnewslist->id}}.shtml">{{$latestnewslist->title}}</a></p>

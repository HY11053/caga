...
class IndexController extends Controller
{
    function Index()
    {
        ...
        //新品上线
        $lbrand=Brandarticle::where('id',263)->first();
        ...
        //项目大全
        $clingshibrands=Brandarticle::whereIn('typeid',[3])->where('flags','like','%'.'s'.'%')->take(3)->latest()->get();
        $flingshibrands=Brandarticle::whereIn('typeid',[3])->where('flags','like','%'.'f'.'%')->take(3)->latest()->get();
        $alingshibrands=Brandarticle::whereIn('typeid',[3])->take(6)->latest()->get();
        $chaohuobrands=Brandarticle::where('typeid',5)->where('flags','like','%'.'s'.'%')->take(3)->latest()->get();
        $fchaohuobrands=Brandarticle::where('typeid',5)->where('flags','like','%'.'f'.'%')->take(3)->latest()->get();
        $achaohuobrands=Brandarticle::where('typeid',5)->take(6)->latest()->get();
        $cjinkoubrands=Brandarticle::where('typeid',4)->where('flags','like','%'.'s'.'%')->take(3)->latest()->get();
        $fjinkoubrands=Brandarticle::where('typeid',4)->where('flags','like','%'.'f'.'%')->take(3)->latest()->get();
        $ajinkoubrands=Brandarticle::where('typeid',4)->take(6)->latest()->get();
        $cpenghuabrands=Brandarticle::where('typeid',10)->where('flags','like','%'.'s'.'%')->take(3)->latest()->get();
        $fpenghuabrands=Brandarticle::where('typeid',10)->where('flags','like','%'.'f'.'%')->take(3)->latest()->get();
        $apenghuabrands=Brandarticle::where('typeid',10)->take(6)->latest()->get();
        //项目排行榜
        ...
        //品牌新闻推荐
        $cnews=Archive::latest()->where('typeid',2)->take(5)->orderBy('id','desc')->get();
        $zhinannews=Archive::latest()->where('typeid',25)->take(5)->orderBy('id','desc')->get();
        $jingyingnews=Archive::latest()->where('typeid',27)->take(5)->orderBy('id','desc')->get();

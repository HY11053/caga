...
class IndexController extends Controller
{
    function Index()
    {
        ...
        $latestbrandnews=Archive::where('brandid','<>','')->where('typeid',2)->latest()->take(4)->get();
        $jmzhinannews=Archive::where('brandid','<>','')->where('typeid',25)->latest()->take(4)->get();
        $touzinews=Archive::where('brandid','<>','')->where('typeid',2)->latest()->take(4)->get();
        $jingyingnews=Archive::where('brandid','<>','')->where('typeid',27)->latest()->take(4)->get();
